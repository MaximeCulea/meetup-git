...
// Also show errors if WP_DEBUG is enabled
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) { ?>
        ...
        <head>
            ...
            <meta name="description" content="Erreur critique">
        ...
        <div class="container">
            <!-- Jumbotron -->
            <div class="jumbotron">
                <h1><i class="fa fa-exclamation-triangle orange"></i> Erreur critique </h1>
                <p class="lead">Le site <em><span id="display-domain"><?php echo $_SERVER['HTTP_HOST']; ?></span></em>
                    est actuellement indisponible.</p>
            ...
            <div class="body-content">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="lead">Une erreur critique est survenue sur le site.</p>
                        <p class="lead">Merci de revenir plus tard. Vous pouvez utiliser le bouton de rechargement de la
                            page.</p>
                    </div>
                    <div class="col-md-6">
                        <h2>Que pouvons-nous faire ?</h2>
                        <p class="lead">Nous nous excusons pour la gêne occasionnée.</p>
                        <p class="lead">Nous metttons tout en oeuvre
                            pour que le site soit à nouveau disponible rapidement.</p>
                    </div>
                </div>
            </div>
        </div>
